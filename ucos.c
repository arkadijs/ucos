...
************************************************************
*/
UBYTE  OSMapTbl[]   = {0x01, 0x02, 0x04, 0x08,
		       0x10, 0x20, 0x40, 0x80};
UBYTE  OSUnMapTbl[] = {
...
void OSInit(void *idle_task_stk, UBYTE maxtasks)
{
    ...
    OSTaskCreate(OSTaskIdle, (void *)0, idle_task_stk, OS_LO_PRIO, "IdleTask");
}
/*
************************************************************
*                       IDLE TASK
...
#ifdef UCOS_IDLE_COUNTER
volatile atomic_t OSIdleTime = { 0 };
#endif
...
************************************************************
*/
UBYTE OSSemInit(OS_SEM *psem, DWORD cnt)
{
    OS_ENTER_CRITICAL();
    if (cnt >= 0) {
	psem->OSSemCnt    = cnt;
...
************************************************************
*/
UBYTE OSSemPend(OS_SEM *psem, UDWORD timeout)
{
    UBYTE x, y, bitx, bity;
...
************************************************************
*/
void *OSMboxPend(OS_MBOX *pmbox, UDWORD timeout, UBYTE *err)
{
    UBYTE  x, y, bitx, bity;
    void  *msg;
...
************************************************************
*/
void *OSQPend(OS_Q *pq, UDWORD timeout, UBYTE *err)
{
    UBYTE  x, y, bitx, bity;
    void  *msg;
