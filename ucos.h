...
extern volatile atomic_t OSIdleTime;
...
void     OSStart(void);
UBYTE    OSTaskCreate(void (*task)(void *dptr), void *data, void *pstk, UBYTE prio, char *name);
...
void     OSLock(void);
void     OSUnlock(void);
UBYTE    OSSemInit(OS_SEM *psem, DWORD value);
